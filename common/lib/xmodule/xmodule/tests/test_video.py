...
class VideoDescriptorImportTestCase(unittest.TestCase):
    ...
    def test_import_val_data_invalid(self, mock_val_api):
        ...
        with self.assertRaises(mock_val_api.ValCannotCreateError):
            VideoDescriptor.from_xml(xml_data, module_system, id_generator)
...
class VideoExportTestCase(VideoDescriptorTestBase):
    ...
    def test_export_to_xml(self, mock_val_api):
        ...
        xml_string = '''\
         <video url_name="SampleProblem" start_time="0:00:01" youtube="0.75:izygArpw-Qo,1.00:p2Q6BrNhdh8,1.25:1EeWXzPdhSA,1.50:rABDYkeK0x8" show_captions="false" end_time="0:01:00" download_video="true" download_track="true" edx_video_id="test_edx_video_id">
           <source src="http://www.example.com/source.mp4"/>
           <source src="http://www.example.com/source.ogg"/>
           <track src="http://www.example.com/track"/>
           <handout src="http://www.example.com/handout"/>
    ...
    def test_export_to_xml_val_error(self, mock_val_api):
        ...
        parser = etree.XMLParser(remove_blank_text=True)
        xml_string = '<video edx_video_id="test_edx_video_id" url_name="SampleProblem" download_video="false"/>'
        expected = etree.XML(xml_string, parser=parser)
        self.assertXmlEqual(expected, xml)
