...
class VideoDescriptor(VideoFields, VideoTranscriptsMixin, VideoStudioViewHandlers, TabsEditingDescriptor, EmptyDataRawDescriptor):
    ...
    def from_xml(cls, xml_data, system, id_generator):
        ...
        field_data = cls._parse_video_xml(xml_object, id_generator.course_id)
    ...
    @classmethod
    def _parse_video_xml(cls, xml, course_id=None):
        """
        Parse video fields out of xml_data. The fields are set if they are
        present in the XML. course_id is used for VAL import if available.
        """
        field_data = {}
        ...
        if (
            ...
            edxval_api.import_from_xml(video_asset_elem, field_data['edx_video_id'], course_id)
